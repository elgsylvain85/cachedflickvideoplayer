...
import 'helpers/progress_bar/progress_bar_settings.dart';
...
class FlickVideoProgressBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    CachedVideoPlayerValue cachedVideoPlayerValue = videoManager.cachedVideoPlayerValue;

    if (cachedVideoPlayerValue == null) return Container();

    void seekToRelativePosition(Offset globalPosition) {
      final box = context.findRenderObject() as RenderBox;
      final Offset tapPos = box.globalToLocal(globalPosition);
      final double relative = tapPos.dx / box.size.width;
      final Duration position = cachedVideoPlayerValue.duration * relative;
